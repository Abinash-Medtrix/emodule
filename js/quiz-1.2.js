...
function nextQuestion() {
  ...
  s += '<div class="instructions">You will now be presented with a learning activity. Please answer the question and click submit to proceed. </br>Choose the correct answer</div>';
